...
test('sanitizer-declaration-clean', (done) => runTest('sanitizer-declaration-clean', done));
test('sanitizer-declaration-tainted', (done) => runTest('sanitizer-declaration-tainted', done));
