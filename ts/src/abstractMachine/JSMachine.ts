...
export default abstract class JSMachine<V, F> implements AbstractMachine {
    ...
    public functionInvokeStartOp: Operation<[string, number, number, StaticDescription], void> =
        this.adviceWrap(
            ([name, expectedArgs, actualArgs, description]) => {
                ...
                console.log("func invoke start: " + this.taintTree.get(0))
            }
        );
    ...
    public functionInvokeEndOp: Operation<[string, StaticDescription], void> =
        this.adviceWrap(
            ([name, description]) => {
                ...
                console.log("func invoke end: " + this.taintTree.get(0))
            }
        );
    ...
    public functionEnterOp: Operation<[string, number, StaticDescription], void> =
        this.adviceWrap(
            ([name, actualArgs, description]) => {
                ...
                console.log("func enter: " + this.taintTree.get(0))
            }
        );
    ...
    public functionExitOp: Operation<[string, number, StaticDescription], void> =
        this.adviceWrap(
            ([name, actualArgs, description]) => {
                ...
                console.log("func exit: " + this.taintTree.get(0))
            }
        );
    ...
    public functionReturnOp: Operation<[string, StaticDescription], void> =
        this.adviceWrap(
            (input) => {
                ...
                console.log("func return: " + this.taintTree.get(0))
            });
    ...
    public literalOp: Operation<[StaticDescription], void> =
        this.adviceWrap(
            ([description]) => {
                ...
                console.log("literal: " + this.taintTree.get(0))
            });
    ...
    public readVarOp: Operation<[VariableDescription, StaticDescription], void> =
        this.adviceWrap(
            ([s, description]) => {
                ...
                console.log("readVar: " + s + " " + this.taintTree.get(0))
            });
    ...
    public writeVarOp: Operation<[VariableDescription, StaticDescription], void> =
        this.adviceWrap(
            ([s, description]) => {
                ...
                console.log("write var: " + s + " " + this.taintTree.get(0) )
            }
        );
    ...
    public readPropertyOp: Operation<[DynamicDescription, Accessor, boolean, StaticDescription], void> =
        this.adviceWrap(
            ([o, s, isMethod, description]) => {
                ...
                console.log("read property: " + this.taintTree.get(0))
            }
        );
    ...
    public writePropertyOp: Operation<[DynamicDescription, Accessor, StaticDescription], void> =
        this.adviceWrap(
            ([o, s, description]) => {
                ...
                console.log("write prop: " + this.taintTree.get(0))
            }
        );
    ...
    public unaryOp: Operation<[StaticDescription], void> =
        this.adviceWrap(
            ([description]) => {
                ...
                console.log("unary: " + this.taintTree.get(0))
            }
        );
    ...
    public binaryOp: Operation<[StaticDescription], void> =
        this.adviceWrap(
            (description) => {
                ...
                console.log("binary: " + this.taintTree.get(0))
            }
        );
    ...
    public initVarOp: Operation<[VariableDescription, StaticDescription], void> =
        this.adviceWrap(
            ([s, description]) => {
                ...
                console.log("initVar: " + this.taintTree.get(0))
            }
        );
    ...
    public builtinOp: Operation<[DynamicDescription, DynamicDescription, number, any, boolean, StaticDescription], void> =
        this.adviceWrap(
            ([name, receiver, actualArgs, extraRecords, isMethod, description]) => {
                ...
                console.log("builtin enter: " + this.taintTree.get(0))
            }
        );
    ...
    public builtinExitOp: Operation<[DynamicDescription, DynamicDescription, StaticDescription], void> =
        this.adviceWrap(
            ([name, returnValueName, description]) => {
                ...
                console.log("builtin exit: " + this.taintTree.get(0))
            }
        );
    ...
    public conditionalOp: Operation<[StaticDescription], void> =
        this.adviceWrap(
            ([description]) => {
                ...
                console.log("conditional start: " + this.taintTree.get(0))
            }
        );
    ...
    public conditionalEndOp: Operation<[StaticDescription], void> =
        this.adviceWrap(
            ([description]) => {
                ...
                console.log("conditional end: " + this.taintTree.get(0))
            }
        );
        ...
        this.adviceWrap(
            ([argumentsObject, description]) => {
               ...
               if (!this.objects.has(argumentsObject)) {
                ...
                console.log("initializeArgObject: " + this.taintTree.get(0))
            }
        );
    ...
    public asyncFunctionEnterOp: Operation<[StaticDescription], void> =
        this.adviceWrap(([description]) => {
            console.log("asyncEnter: " + this.taintTree.get(0))
        });
    ...
    public awaitPreOp: Operation<[number, DynamicDescription, any, StaticDescription], void> =
        this.adviceWrap(([id, promiseId, promiseOrValAwaited, description]) => {
            ...
            console.log("awaitPre: " + this.taintTree.get(0))
        });
    ...
    public promiseReactionOp: Operation<[number, any, DynamicDescription, StaticDescription], void> =
        this.adviceWrap(([id, promiseValue, promiseId, description]) => {
            let promiseTaint: V = this.promiseMap.get(promiseId).resolve;

            this.varTaintMap.set(promiseValue, promiseTaint);

            console.log("PromsieResolve: " + promiseId + " " + promiseValue + " taint: " + this.varTaintMap.get(promiseValue));
            console.log("promiseReaction: " + this.taintTree.get(0))
    ...
    public promiseResolveOp: Operation<[number, any, DynamicDescription, StaticDescription], void> =
        this.adviceWrap(([id, promiseValue, promiseId, description]) => {
            ...
            console.log("PromsieResolve: " + promiseId + " " + promiseValue + " taint: " + this.varTaintMap.get(promiseValue));
            console.log("promiseResolve: " + this.taintTree.get(0) + " from Map: " +  JSON.stringify(this.promiseMap.get(promiseId)))
        });
