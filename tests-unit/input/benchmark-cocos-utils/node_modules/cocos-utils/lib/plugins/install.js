...
var pluginCfg = new PluginCfg(consts.F_INSTALL, msgCode.DESC_INSTALL, {length : 0});
...
function run(currDir, args, opts){
    ...
    exec("npm " + regStr + " install cocos2d-html5", function(err, stdout, stderr){
        ...
        console.log("npm " + regStr + " install");
        exec("npm " + regStr + " install", function(err1, stdout1, stderr1){
            console.log(stderr1);
            console.log(stdout1);
