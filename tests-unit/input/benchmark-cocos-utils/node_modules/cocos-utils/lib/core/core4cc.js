 ...
 * @param {String} msg       code for msg
 * @param [{}] args          replacer for msg
 * @returns {*}
 */
core4cc.assert = function(flag, msg, args){
    if(flag) return;
    throw msgCode.ERR_PRE + core4cc.getMsg(msg, args);
};
 ...
 * @returns {*}
 */
core4cc.getMsg = function(msg, args){
    if(!args) return msg;
    for(var key in args){
        if(!key) continue;
 ...
 * @returns {*}
 */
core4cc.log = function(msg, args){
    console.log(core4cc.getMsg(msg, args));
};
/**
 * Desc: Warn message.
 * @param code
 * @param args
 */
core4cc.warn = function(msg, args){
    console.log(msgCode.WARN_PRE + core4cc.getMsg(msg, args));
};
