exports.drive = (m) => {
    ...
    m.readVar(["global^a", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[7,21],"end":[7,22]}},"name":"a"}]);

    m.functionInvokeStart(["global@3", 1, 2, {"type":"functionInvocation","location":{"fileName":"test.js","pos":{"start":[7,9],"end":[7,23]}},"name":"identity"}]);
