exports.drive = (m) => {
    ...
    m.readVar("a", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[7,21],"end":[7,22]}},"name":"a"});

    m.functionCall("identity", 1, 2, {"type":"functionInvocation","location":{"fileName":"test.js","pos":{"start":[7,9],"end":[7,23]}},"name":"identity"});
    ...
    m.functionReturn("identity", {"type":"functionReturn","location":{"fileName":"test.js","pos":{"start":[7,9],"end":[7,23]}},"name":"identity"});

    m.writeVar("z", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[7,5],"end":[7,23]}},"name":"z"});
