exports.drive = (m) => {
    ...
    m.readVar(["global^b", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[3,9],"end":[3,12]}},"name":"b"}]);
    ...
    m.writeVar(["global^b", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[3,9],"end":[3,12]}},"name":"b"}]);
