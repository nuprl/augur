exports.drive = (m) => {
    ...
    m.readVar("a", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[3,28],"end":[3,29]}},"name":"a"});

    m.writeVar("i", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[3,24],"end":[3,29]}},"name":"i"});

    m.writeVar("z", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[3,20],"end":[3,29]}},"name":"z"});

    m.pop({"type":"expr","location":{"fileName":"test.js","pos":{"start":[3,20],"end":[3,29]}}});
