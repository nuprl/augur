exports.drive = (m) => {
    ...
    m.writeVar(["global^i", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[3,6],"end":[3,11]}},"name":"i"}]);

    m.pop([{"type":"expr","location":{"fileName":"test.js","pos":{"start":[3,6],"end":[3,11]}}}]);

    m.readVar(["global^i", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[3,13],"end":[3,14]}},"name":"i"}]);

    m.literal([{"type":"literal","location":{"fileName":"test.js","pos":{"start":[3,17],"end":[3,18]}}}]);

    m.binary([{"type":"expr","location":{"fileName":"test.js","pos":{"start":[3,13],"end":[3,18]}}}]);
    ...
    m.readVar(["global^a", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[3,24],"end":[3,25]}},"name":"a"}]);

    m.writeVar(["global^i", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[3,20],"end":[3,25]}},"name":"i"}]);
