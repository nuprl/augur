exports.drive = (m) => {
    ...
    m.initVar(["global^buildContainer", {"type":"declaration","location":{"fileName":"test.js","pos":{"start":[1,2],"end":[14,2]}},"name":"buildContainer"}]);
    ...
    m.initVar(["global^x", {"type":"declaration","location":{"fileName":"test.js","pos":{"start":[1,2],"end":[14,2]}},"name":"x"}]);
    ...
    m.readVar(["global^buildContainer", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[10,9],"end":[10,23]}},"name":"buildContainer"}]);

    m.readVar(["global^a", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[10,24],"end":[10,25]}},"name":"a"}]);

    m.functionInvokeStart(["global@3", 1, 1, {"type":"functionInvocation","location":{"fileName":"test.js","pos":{"start":[10,9],"end":[10,26]}},"name":"buildContainer"}]);
    ...
    m.functionInvokeEnd(["global@3", {"type":"functionReturn","location":{"fileName":"test.js","pos":{"start":[10,9],"end":[10,26]}},"name":"buildContainer"}]);

    m.writeVar(["global^x", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[10,5],"end":[10,26]}},"name":"x"}]);

    m.pop([{"type":"expr","location":{"fileName":"test.js","pos":{"start":[10,5],"end":[10,26]}}}]);

    m.readVar(["global^buildContainer", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[11,1],"end":[11,15]}},"name":"buildContainer"}]);

    m.literal([{"type":"literal","location":{"fileName":"test.js","pos":{"start":[11,16],"end":[11,17]}}}]);

    m.functionInvokeStart(["global@3", 1, 1, {"type":"functionInvocation","location":{"fileName":"test.js","pos":{"start":[11,1],"end":[11,18]}},"name":"buildContainer"}]);
    ...
    m.functionInvokeEnd(["global@3", {"type":"functionReturn","location":{"fileName":"test.js","pos":{"start":[11,1],"end":[11,18]}},"name":"buildContainer"}]);

    m.pop([{"type":"expr","location":{"fileName":"test.js","pos":{"start":[11,1],"end":[11,18]}}}]);

    m.readVar(["global^x", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[12,5],"end":[12,6]}},"name":"x"}]);

    m.readProperty(["obj0", "value", {"type":"expr","location":{"fileName":"test.js","pos":{"start":[12,5],"end":[12,12]}}}]);

    m.writeVar(["global^z", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[12,1],"end":[12,12]}},"name":"z"}]);

    m.pop([{"type":"expr","location":{"fileName":"test.js","pos":{"start":[12,1],"end":[12,12]}}}]);
