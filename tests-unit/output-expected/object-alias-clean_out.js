exports.drive = (m) => {
    ...
    m.initVar(["global^b", {"type":"declaration","location":{"fileName":"test.js","pos":{"start":[1,2],"end":[10,2]}},"name":"b"}]);

    m.initVar(["global^c", {"type":"declaration","location":{"fileName":"test.js","pos":{"start":[1,2],"end":[10,2]}},"name":"c"}]);

    m.initVar(["global^z", {"type":"declaration","location":{"fileName":"test.js","pos":{"start":[1,2],"end":[10,2]}},"name":"z"}]);
    ...
    m.literal([{"type":"literal","location":{"fileName":"test.js","pos":{"start":[6,11],"end":[6,13]}}}]);

    m.writeProperty(["obj0", "field", {"type":"expr","location":{"fileName":"test.js","pos":{"start":[6,1],"end":[6,13]}}}]);

    m.pop([{"type":"expr","location":{"fileName":"test.js","pos":{"start":[6,1],"end":[6,13]}}}]);
