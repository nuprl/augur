exports.drive = (m) => {
    ...
    m.writeVar(["global^returnUntainted", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[4,1],"end":[6,2]}},"name":"returnUntainted"}]);

    m.literal([{"type":"literal","location":{"fileName":"test.js","pos":{"start":[8,1],"end":[12,2]}}}]);

    m.writeVar(["global^returnTainted", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[8,1],"end":[12,2]}},"name":"returnTainted"}]);
    ...
    m.readVar(["global^returnTainted", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[14,1],"end":[14,14]}},"name":"returnTainted"}]);

    m.functionInvokeStart(["global@3", 0, 0, {"type":"functionInvocation","location":{"fileName":"test.js","pos":{"start":[14,1],"end":[14,16]}},"name":"returnTainted"}]);

    m.functionEnter(["global@3", 0, {"type":"functionEnter","location":{"fileName":"test.js","pos":{"start":[8,1],"end":[12,2]}}}]);

    m.readVar(["global^returnUntainted", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[10,21],"end":[10,36]}},"name":"returnUntainted"}]);

    m.writeVar(["global^returnTainted", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[10,5],"end":[10,36]}},"name":"returnTainted"}]);

    m.pop([{"type":"expr","location":{"fileName":"test.js","pos":{"start":[10,5],"end":[10,36]}}}]);
    ...
    m.functionExit(["global@3", 8, {"type":"expr","location":{"fileName":"test.js","pos":{"start":[8,1],"end":[12,2]}}}]);

    m.functionInvokeEnd(["global@3", {"type":"functionReturn","location":{"fileName":"test.js","pos":{"start":[14,1],"end":[14,16]}},"name":"returnTainted"}]);

    m.pop([{"type":"expr","location":{"fileName":"test.js","pos":{"start":[14,1],"end":[14,16]}}}]);

    m.readVar(["global^returnTainted", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[15,5],"end":[15,18]}},"name":"returnTainted"}]);

    m.functionInvokeStart(["global@6", 0, 0, {"type":"functionInvocation","location":{"fileName":"test.js","pos":{"start":[15,5],"end":[15,20]}},"name":"returnUntainted"}]);

    m.functionEnter(["global@6", 0, {"type":"functionEnter","location":{"fileName":"test.js","pos":{"start":[4,1],"end":[6,2]}}}]);

    m.literal([{"type":"literal","location":{"fileName":"test.js","pos":{"start":[5,12],"end":[5,13]}}}]);

    m.functionReturn(["global@6", {"type":"functionReturn","location":{"fileName":"test.js","pos":{"start":[5,5],"end":[5,14]}}}]);

    m.functionExit(["global@6", 8, {"type":"expr","location":{"fileName":"test.js","pos":{"start":[4,1],"end":[6,2]}}}]);

    m.pop([{"type":"expr","location":{"fileName":"test.js","pos":{"start":[5,5],"end":[5,14]}}}]);

    m.functionInvokeEnd(["global@6", {"type":"functionReturn","location":{"fileName":"test.js","pos":{"start":[15,5],"end":[15,20]}},"name":"returnUntainted"}]);

    m.writeVar(["global^z", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[15,1],"end":[15,20]}},"name":"z"}]);

    m.pop([{"type":"expr","location":{"fileName":"test.js","pos":{"start":[15,1],"end":[15,20]}}}]);
