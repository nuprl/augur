exports.drive = (m) => {
    ...
    m.readVar("a", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[12,11],"end":[12,12]}},"name":"a"});
    ...
    m.readVar("x", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[5,12],"end":[5,13]}},"name":"x"});
