exports.drive = (m) => {
    ...
    m.initVar(["global^c", {"type":"declaration","location":{"fileName":"test.js","pos":{"start":[1,2],"end":[7,2]}},"name":"c"}]);
    ...
    m.writeVar(["global^z", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[4,5],"end":[4,11]}},"name":"z"}]);
    ...
    m.writeVar(["global^b", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[5,9],"end":[5,14]}},"name":"b"}]);

    m.writeVar(["global^c", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[5,5],"end":[5,14]}},"name":"c"}]);

    m.writeVar(["global^z", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[5,1],"end":[5,14]}},"name":"z"}]);
