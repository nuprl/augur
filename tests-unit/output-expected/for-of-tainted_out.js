exports.drive = (m) => {
    ...
    m.initVar(["global^k", {"type":"declaration","location":{"fileName":"test.js","pos":{"start":[1,2],"end":[8,2]}},"name":"k"}]);
    ...
    m.readVar(["global^b", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[5,15],"end":[5,16]}},"name":"b"}]);

    m.pop([{"type":"expr","location":{"fileName":"test.js","pos":{"start":[5,15],"end":[5,16]}}}]);

    m.writeVar(["global^k", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[5,10],"end":[5,11]}},"name":"k"}]);

    m.pop([{"type":"expr","location":{"fileName":"test.js","pos":{"start":[5,10],"end":[5,11]}}}]);

    m.readVar(["global^k", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[6,9],"end":[6,10]}},"name":"k"}]);

    m.writeVar(["global^z", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[6,5],"end":[6,10]}},"name":"z"}]);
