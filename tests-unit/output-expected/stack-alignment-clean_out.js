exports.drive = (m) => {
    ...
    m.literal([{"type":"literal","location":{"fileName":"test.js","pos":{"start":[24,15],"end":[24,16]}}}]);
    ...
    m.readVar(["global^a", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[10,9],"end":[10,10]}},"name":"a"}]);
