exports.drive = (m) => {
    ...
    m.literal([{"type":"literal","location":{"fileName":"test.js","pos":{"start":[3,5],"end":[3,10]}}}]);

    m.readVar(["global^a", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[6,9],"end":[6,10]}},"name":"a"}]);
