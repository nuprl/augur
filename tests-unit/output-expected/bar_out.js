exports.drive = (m) => {
    ...
    m.readVar("bar", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[10,1],"end":[10,4]}},"name":"bar"});

    m.functionCall("bar", 0, 0, {"type":"functionInvocation","location":{"fileName":"test.js","pos":{"start":[10,1],"end":[10,6]}},"name":"bar"});
    ...
    m.functionReturn("bar", {"type":"functionReturn","location":{"fileName":"test.js","pos":{"start":[10,1],"end":[10,6]}},"name":"bar"});
