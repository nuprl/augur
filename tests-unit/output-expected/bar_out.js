exports.drive = (m) => {
    ...
    m.readVar(["global^bar", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[10,1],"end":[10,4]}},"name":"bar"}]);

    m.functionInvokeStart(["global@3", 0, 0, {"type":"functionInvocation","location":{"fileName":"test.js","pos":{"start":[10,1],"end":[10,6]}},"name":"bar"}]);
    ...
    m.functionInvokeEnd(["global@3", {"type":"functionReturn","location":{"fileName":"test.js","pos":{"start":[10,1],"end":[10,6]}},"name":"bar"}]);
