exports.drive = (m) => {
    ...
    m.readVar(["global^a", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[14,23],"end":[14,24]}},"name":"a"}]);

    m.readVar(["global^b", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[14,26],"end":[14,27]}},"name":"b"}]);

    m.functionInvokeStart(["global@5", 2, 2, {"type":"functionInvocation","location":{"fileName":"test.js","pos":{"start":[14,11],"end":[14,28]}},"name":"o4"}]);
    ...
    m.functionInvokeEnd(["global@5", {"type":"functionReturn","location":{"fileName":"test.js","pos":{"start":[14,11],"end":[14,28]}},"name":"o4"}]);

    m.writeVar(["global^sum", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[14,5],"end":[14,28]}},"name":"sum"}]);

    m.pop([{"type":"expr","location":{"fileName":"test.js","pos":{"start":[14,5],"end":[14,28]}}}]);
