exports.drive = (m) => {
    ...
    m.literal([{"type":"literal","location":{"fileName":"test.js","pos":{"start":[4,24],"end":[4,25]}}}]);
    ...
    m.readVar(["global^c", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[6,5],"end":[6,6]}},"name":"c"}]);

    m.writeVar(["global^z", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[6,1],"end":[6,6]}},"name":"z"}]);

    m.pop([{"type":"expr","location":{"fileName":"test.js","pos":{"start":[6,1],"end":[6,6]}}}]);
