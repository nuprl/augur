exports.drive = (m) => {
    ...
    m.readVar("c", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[6,5],"end":[6,6]}},"name":"c"});

    m.writeVar("z", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[6,1],"end":[6,6]}},"name":"z"});
