exports.drive = (m) => {
    ...
    m.readVar("a", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[2,32],"end":[2,33]}},"name":"a"});
    ...
    m.writeVar("b", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[2,5],"end":[2,34]}},"name":"b"});
    ...
    m.literal({"type":"literal","location":{"fileName":"test.js","pos":{"start":[3,11],"end":[3,15]}}});

    m.readProperty("obj0", "2a", {"type":"expr","location":{"fileName":"test.js","pos":{"start":[3,9],"end":[3,16]}}});

    m.writeVar("z", {"type":"variable","location":{"fileName":"test.js","pos":{"start":[3,5],"end":[3,16]}},"name":"z"});
